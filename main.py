"""
    ...
    Key Takeaways.
        ...
        2. It is recommended to use keyword arguments e.g. my_function(c = 3, a = 1, b = 2)
           instead of positional arguments e.g. my_function(1, 2, 3) when working with functions
           you did not create.
"""
